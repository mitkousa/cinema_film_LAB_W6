...
describe('Cinema', function () {
  ...
  it('should be able to get a list of film titles', function () {
    ...
    assert.deepStrictEqual(actual, cinema.listFilmTitles())
    
  });
  it('should be able to find a film by title', function () {
    const actual = [moonlight]
    assert.deepStrictEqual(actual, cinema.filmByTitle('Moonlight'))
  });
   
  it('should be able to filter films by genre', function () {
    const actual = [moonlight, trainspotting]
    assert.deepStrictEqual(actual, cinema.filmByGenre('drama'))
  });
  it('should be able to check whether there are some films from a particular year', function(){
    const actual = [bladeRunner, dunkirk, trainspotting]
    assert.deepStrictEqual(actual, cinema.filmByYear(2017))
  });
  it('should be able to check whether there are no films from a particular year', function(){
    const actual = []
    assert.deepStrictEqual(actual, cinema.filmByYear(2022))
  });
